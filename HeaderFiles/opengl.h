...
typedef void WINAPI wglBufferData(GLenum target, GLsizeiptr size,
                                    const GLvoid * data, GLenum usage);

typedef void WINAPI wglEnableVertexAttribArray(GLuint index);
typedef void WINAPI wglVertexAttribPointer(GLuint index, GLint size,
...
typedef void WINAPI wglShaderSource(GLuint shader, GLsizei count,
...
typedef void WINAPI wglGetShaderInfoLog(GLuint shader, GLsizei maxLength,
